	...
	*/
	...
	if (iRtn == 1) {
		...
		*/
		...
		System.out.println("본인확인 수단 : " + sAuthInfo + "<BR>");
		System.out.println("연계정보 확인값 (CI) : " + sCoInfo1 + "<BR>");
		System.out.println("CI 갱신정보 : " + sCIUpdate + "<BR>");
		...
		PN = "iRtn 값, 서버 환경정보를 정확히 확인하여 주시기 바랍니다.";
	} else if (iRtn == -6) {
		...
		PN = "당사는 한글 charset 정보를 euc-kr 로 처리하고 있으니, euc-kr 에 대해서 허용해 주시기 바랍니다.<BR>"
		...
		PN = "입력값 오류 : fnResponse 함수 처리시, 필요한 파라미터값의 정보를 정확하게 입력해 주시기 바랍니다.";
	} else if (iRtn == -12) {
		//sRtnMsg = "CP 비밀번호 불일치 : IPIN 서비스 사이트 패스워드를 확인해 주시기 바랍니다.";
		PN = "CP 비밀번호 불일치 : IPIN 서비스 사이트 패스워드를 확인해 주시기 바랍니다.";
	} else if (iRtn == -13) {
		//sRtnMsg = "CP 요청번호 불일치 : 세션에 넣은 sCPRequest 데이타를 확인해 주시기 바랍니다.";
		PN = "CP 요청번호 불일치 : 세션에 넣은 sCPRequest 데이타를 확인해 주시기 바랍니다.";
	} else {
		//sRtnMsg = "iRtn 값 확인 후, NICE평가정보 개발 담당자에게 문의해 주세요.";
		PN = "iRtn 값 확인 후, NICE평가정보 개발 담당자에게 문의해 주세요.";
	}
%>
