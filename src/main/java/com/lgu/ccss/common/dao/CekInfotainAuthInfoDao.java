...
@Component
public class CekInfotainAuthInfoDao {
	...
	public int insertCekInfotainAuthInfo(String membId,String mgrappId, String serviceId, String tokenName, String tokenValue, String nid) {
		if(membId == null  ||  mgrappId == null || serviceId == null || tokenName == null || tokenValue == null || nid == null) {
			throw new IllegalArgumentException();
		}
	
		CekInfotainAuthInfoVO infotainAuthInfo = new CekInfotainAuthInfoVO();
		...
		infotainAuthInfo.setNid(nid);
		infotainAuthInfo.setRegId(systemId);
		infotainAuthInfo.setUpdId(systemId);
		
		infotainAuthInfo.setMgrappId(mgrappId);
		
		return commonDao_oracle.insert("CekInfotainment.insertCekInfotatinAuthInfo", infotainAuthInfo);
	}
	
	
	public List<CekInfotainAuthInfoVO> selectInfotainAuthInfo(String membId) {
		if(membId == null) {
			throw new IllegalArgumentException();
		}
		...
		return commonDao_oracle.selectList("CekInfotainment.selectCekInfotainAuthInfoByMembId", infotainAuthInfo);
	}
	
	public List<CekInfotainAuthInfoVO> selectInfotainAuthInfo(String membId, String serviceId) {
		...
		return commonDao_oracle.selectList("CekInfotainment.selectCekInfotainAuthInfoByServiceId", infotainAuthInfo);
	}
	...
	public int insertCekInfotainAuthInfoForSa(String membId,String serviceId, String tokenName, String tokenValue) {
		if(membId == null  || serviceId == null || tokenName == null || tokenValue == null) {
			throw new IllegalArgumentException();
		}
		...
		return commonDao_oracle.insert("CekInfotainment.insertCekInfotatinAuthInfoForSa", infotainAuthInfo);
	}


	public int deleteCekInfotainAuthInfo(String membId, String serviceId, String nid) {
		if(membId == null  || serviceId == null) {
			throw new IllegalArgumentException();
		}
		CekInfotainAuthInfoVO infotainAuthInfo = new CekInfotainAuthInfoVO();
		...
		return commonDao_oracle.delete("CekInfotainment.deleteCekInfotainAuthInfoByServiceId", infotainAuthInfo);
	}
}
