...
public class AisvAuthResponseDataJSON {
	...
	private AisvAuthResponseCekInfoJSON cekInfo;
	...
	public AisvAuthResponseCekInfoJSON getCekInfo() {
		return cekInfo;
	}

	public void setCekInfo(AisvAuthResponseCekInfoJSON cekInfo) {
		this.cekInfo = cekInfo;
	}

	@Override
	public String toString() {
		return "AisvAuthResponseDataJSON [oneId=" + oneId + ", oneIdKey=" + oneIdKey + ", ssoKey=" + ssoKey
				+ ", tempIdYn=" + tempIdYn + ", ctn=" + ctn + ", aiTempIdYn=" + aiTempIdYn + ", aisvToken=" + aisvToken
				+ ", cekInfo=" + cekInfo + "]";
	}
