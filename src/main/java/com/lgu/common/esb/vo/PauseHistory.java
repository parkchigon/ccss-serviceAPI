...
public class PauseHistory {
	...
	public String toString() {
		return "PauseHistory [entrSttsValdStrtDt=" + entrSttsValdStrtDt + ", entrSttsValdEndDt=" + entrSttsValdEndDt
				+ ", prodNo=" + prodNo + ", prodNm=" + prodNm + ", entrSttsChngRsnDtlNm=" + entrSttsChngRsnDtlNm
				+ ", entrSttsNm=" + entrSttsNm + ", entrSttsChngSeqno=" + entrSttsChngSeqno + "]";
	}
