...
public class ByteBuffer
{
    ...
    throws UnsupportedEncodingException
    {
    	...
    	if( tmpString != null && tmpString.length() < count )
    	{
    		int size = count - tmpString.length();
    		for( int i = 0; i < size; i++ )
    			tmpString = tmpString + " ";
    	}
    		
        String subStr = tmpString.substring(0,count);
    ...
    public String removeCString(String encoding)
    throws NotEnoughDataInByteBufferException, TerminatingZeroNotFoundException
