...
public class Data
{
    ...
    //@@@ 20090410 RAW_TRAN_ID
    public static final int SM_RAW_TRAN_ID_LEN_MAX = 10;
    public static final int SM_RAW_TRAN_ID_LEN_MIN = 0;
    ...
    public static final String SERVICE_WPUSH        = "WPUSH";
    public static final String SERVICE_CALLBACK		= "CBURL";
    ...
    //@@@JYLEE BECAUSE CALLBACK URL 19 -> 84 ��
    public static final int OPT_PAR_CALLBACK_NUM_MAX    	= 84;
    
    //CallBack url
    public static final short OPT_PAR_CALLBACK_URL        	= 0x1403;
    public static final int OPT_PAR_CALLBACK_URL_MIN    	= 4;
    //@@@JYLEE BECAUSE CALLBACK URL 19 -> 84 ��
    public static final int OPT_PAR_CALLBACK_URL_MAX    	= 84;
    ...
    //@@@ 20080326 jylee optional filed append
    public static final short OPT_PAR_MESSAGE_KIND      = 0x1401;
    
    //@@@ 20080326 jylee optional filed append
    public static final short OPT_PAR_TELECOM_TYPE      = 0x1402;
    
    //  @@@ 20080528 jylee optional filed append
    public static final short OPT_PAR_CLIENT_ID      	= 0x2001;
    
    // @@@ 20090410
    public static final short OPT_PAR_RAW_TRAN_ID      	= 0x1404;
    
    // @@@ 20090410 jylee appand sub cp id
    public static final short OPT_PAR_SUB_CP_ID      	= 0x1405;
    public static final int SUB_CP_ID_LEN_MIN			= 0;
    public static final int SUB_CP_ID_LEN_MAX			= 16;
    
    //@@@ 20080326 jylee optional filed append
    public static final byte OPT_VAL_MESSAGE_KIND_AD    = 0x01;
    public static final byte OPT_VAL_MESSAGE_KIND_EN    = 0x02;
    
    //@@@ 20080326 jylee optional filed append
    public static final byte OPT_VAL_TElECOM_TYPE_SKT    = 0x01;
    public static final byte OPT_VAL_TElECOM_TYPE_KTF    = 0x02;
    public static final byte OPT_VAL_TElECOM_TYPE_LGT    = 0x03;
    public static final byte OPT_VAL_TElECOM_TYPE_INDI   = 0x04;
    ...
    public static final long RECEIVER_TIMEOUT           = 10000;
    ...
    public static final byte DATA_ENCODING_KSC5601		= 0x0e;
