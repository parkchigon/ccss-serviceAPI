...
public final class LocalServerReceiver implements VerificationCodeReceiver {
	...
	private long CONN_TIMEOUT = 10 * 1000L;
	...
	private void createTimer(long timeout) {
		try {
			TimerTask task = new MyTimerTask(this);
			connectionTimer = new Timer();
			connectionTimer.schedule(task, timeout);
  ...
  class CallbackHandler extends AbstractHandler {
	...
	public class MyTimerTask extends TimerTask {
		public LocalServerReceiver serverReceiver;
		
		public MyTimerTask(LocalServerReceiver serverReceiver)
		{
		...
		private void completeTask() {
			try {
				this.serverReceiver.serverStopWakeup();
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
