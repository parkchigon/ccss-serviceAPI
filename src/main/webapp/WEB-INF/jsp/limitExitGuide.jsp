...
<script type="text/javascript">
	...
	function closeExitGuide() {
		var val = $("#check").is(":checked");

		android.closeExitGuide(val);
	}
		...
		<div class="container">
			...
			<div class="inner-cont">
				<div class="inbox-scroll" id="scroll">
					...
					<div class="wrapper">
						<!-- 본문 -->
						<h1>커넥티드카 "태블릿/스마트기기 데이터 10GB" 무료 이용 종료 안내</h1>
						<div class="expire-notice">
							<p class="note"><!-- 20190128 kangjin -->
								고객님께 제공 중인 "태블릿/스마트기기 데이터 10GB" ${svcYear}년 무료 이용 기간이 ${svcEndDttm2}로
								종료되었습니다.<br />커넥티드카 서비스를 계속 이용하시려면 "월정액 요금제2"로 변경해 주세요.<br />
								(음성인식,인포테인먼트,LTE DATA)
							</p>
							<p class="price">서비스명 : LTE) 태블릿/스마트기기 데이터 10GB</p>
							<div class="t-grid">
								<table>
									...
									<tbody>
										<tr>
											<td rowspan="3">13,200원(부가세 포함금액)</td>
							...
							<p class="info">커넥티드카 서비스 가입자는 추가 할인을 통해 월 13,200원에 이용 하실 수
								있습니다 ${strJini}</p>
			...
			<a href="#" class="top">TOP</a> </section>
			<!-- //내용(공통) -->
			...
			<div class="bt">
				<a href="javascript:;" class="btn-line" onclick="closeExitGuide();">닫기</a>
				<a href="javascript:;" class="btn-line" onclick="goApplyPlan();">변경하기</a>
			</div>
			</footer>
			<!-- //하단(공통) -->
		</div>
